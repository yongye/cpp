...
//   Version: 1.0.9 02/20/2013 BeiJing China [Updated 01/25/1015]        //
//                                                                       //
//   Algorithm:                                                          //
//                                                                       //
//   [][] [][]   [][]            [][]   [][]          [][]   [][] [][]   //
...
int get_args(vector<string>& args)
{
    ...
    else if ( args_len == 2 )
    {
       ...
       {
            cout << "Tetris Game  Version 1.0.9 [Updated 01/25/1015]" << endl;
            return 1;
       }
       else
       {
...
void board::notify()
{
     ...
     cout << "\e[38;5;106;1m\e["+to_string(toph+19)+";"+to_string(dist)+"HTetris Game  Version 1.0.9\n";
     string str12 = "\e["+to_string(toph+20)+";"+to_string(dist)+"HYongYe <complex.invoke@gmail.com>\e[";
     string str13 = to_string(toph+21)+";"+to_string(dist)+"H02/20/2013 BeiJing China [Updated 01/25/1015]";
